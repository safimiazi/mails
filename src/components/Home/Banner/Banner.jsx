...
export const Banner = () => {
  ...
  return (
    <div className="h-72 w-full md:h-[470px] lg:h-[540px] relative overflow-hidden">
        {/* arrow left */}
        ...
        {/* Carousel container */}
        <div className="relative  ease-linear duration-500 flex transform-gpu" style={{ transform: `translateX(-${currentSlider * 100}%)`}}>
          {/* sliders */}
